...
namespace RNGenie.Core.Dist
{
    ...
    /// <para>
    /// Implementations (e.g. <see cref="Uniform01"/>, <see cref="Triangular"/>, <see cref="NormalBoxMuller"/>)
    /// encapsulate the sampling logic; determinism depends on the provided RNG (e.g. <see cref="Pcg32Source"/>.
    /// </para>
    /// </summary>
